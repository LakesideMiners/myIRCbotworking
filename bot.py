...
import socket, re, subprocess, os, time, threading, sys, keep_alive


# Some basic variables used to configure the bot        
server = "chat.freenode.net" # Server
channel = "##RhinosF1" # Channel
botnick = "RedsFoxBot" # Your bots nick
  ...
  while 1: 
    ...
    if ircmsg.find("PRIVMSG") != -1:
      ...
      if message[:2] == 's|':
        ...
        sendmsg("https://en.wikipedia.org/wiki/" + message[0:].upper())
      else:
